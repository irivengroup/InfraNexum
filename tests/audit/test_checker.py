...
FILES = (
    ...
    "components/core/audit/MANIFEST.json",
    "components/core/audit/pom.xml",
    "components/core/audit/audit-contract-pack.json",
    "components/core/audit/main/io/infranexum/core/audit/AuditEntry.java",
    "components/core/audit/main/io/infranexum/core/audit/AuditJournal.java",
    "components/core/audit/main/io/infranexum/core/audit/AuditCanonicalizer.java",
    "components/core/audit/main/io/infranexum/core/audit/AuditExportService.java",
    "components/core/audit/main/io/infranexum/core/audit/AuditExportVerifier.java",
    "components/core/audit/main/io/infranexum/core/audit/AuditPurgeTombstone.java",
    "components/adapters/jdbc/MANIFEST.json",
    "components/adapters/jdbc/pom.xml",
    "components/adapters/jdbc/main/io/infranexum/adapters/persistence/jdbc/JdbcAuditJournal.java",
    "distribution/migrations/0005-core-audit/migration.yaml",
    "distribution/migrations/0005-core-audit/postgresql.sql",
    "distribution/migrations/0005-core-audit/oracle.sql",
    "distribution/migrations/0005-core-audit/verify.sql.yaml",
    "distribution/migrations/0005-core-audit/rollback/postgresql.sql",
    "distribution/migrations/0005-core-audit/rollback/oracle.sql",
)
...
class AuditCheckerTest(unittest.TestCase):
    ...
    def test_reactor_ci_and_manifest_wiring_are_enforced(self) -> None:
        cases = (
            (FILES[0], "<module>components/core/audit</module>"),
            (FILES[1], "audit-test"),
