...
FILES = (
    ...
    "components/core/capabilities/main/io/infranexum/core/capabilities/ActivationState.java",
    "components/core/entitlements/MANIFEST.json",
    "components/core/entitlements/pom.xml",
    "components/core/entitlements/resources/io/infranexum/core/entitlements/activation-manifest.schema.json",
    "components/core/entitlements/resources/io/infranexum/core/entitlements/entitlement-contract-pack.json",
    "components/core/entitlements/main/io/infranexum/core/entitlements/ActivationManifestPayload.java",
    "components/core/entitlements/main/io/infranexum/core/entitlements/ActivationManifestVerifier.java",
    "components/core/entitlements/main/io/infranexum/core/entitlements/LiteEvaluationPolicy.java",
    "components/core/entitlements/main/io/infranexum/core/entitlements/TrustedTimeGuard.java",
    "components/core/entitlements/main/io/infranexum/core/entitlements/IntegrityProof.java",
    "distribution/migrations/0004-core-entitlements/migration.yaml",
    "distribution/migrations/0004-core-entitlements/postgresql.sql",
    "distribution/migrations/0004-core-entitlements/oracle.sql",
    "distribution/migrations/0004-core-entitlements/logical-model.json",
    "distribution/migrations/0004-core-entitlements/verify.sql.yaml",
    "applications/server/pom.xml",
    "applications/server/MANIFEST.json",
    "components/core/entitlements/main/io/infranexum/core/entitlements/EntitlementGuard.java",
    "components/core/entitlements/main/io/infranexum/core/entitlements/EntitlementAccessException.java",
    "components/core/entitlements/main/io/infranexum/core/entitlements/EntitlementRuntimeAuthority.java",
    "components/core/entitlements/main/io/infranexum/core/entitlements/EntitlementRuntimeStatus.java",
    "components/core/entitlements/main/io/infranexum/core/entitlements/EntitlementRuntimeRepository.java",
    "components/adapters/jdbc/main/io/infranexum/adapters/persistence/jdbc/JdbcActivationOperationalRepository.java",
    "components/adapters/jdbc/main/io/infranexum/adapters/persistence/jdbc/FileIntegrityProofStore.java",
    "components/adapters/jdbc/main/io/infranexum/adapters/persistence/jdbc/JdbcRevocationRegistry.java",
    "applications/server/main/io/infranexum/server/platform/entitlements/ActivationRuntimeConfiguration.java",
    "applications/server/main/io/infranexum/server/platform/entitlements/ActivationRuntimeProperties.java",
    "applications/server/main/io/infranexum/server/platform/entitlements/EntitlementWebServerStartupGuard.java",
    "applications/server/main/io/infranexum/server/platform/entitlements/EntitlementMutationInterceptor.java",
    "applications/server/main/io/infranexum/server/platform/entitlements/EvaluationStatusController.java",
    "applications/server/main/io/infranexum/server/platform/entitlements/EntitlementExceptionHandler.java",
    "applications/server/resources/application.yaml",
    "applications/server/resources/contracts/activation-trust-store.schema.json",
    "applications/server/resources/openapi/platform-entitlements.yaml",
)
...
class EntitlementCheckerTest(unittest.TestCase):
    ...
    def test_reactor_server_ci_and_policy_wiring_are_enforced(self) -> None:
        mutations = (
            (FILES[0], "<module>components/core/entitlements</module>"),
    ...
    def test_key_material_is_forbidden(self) -> None:
        key = self.root / "components/core/entitlements/private.key"
