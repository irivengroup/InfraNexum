...
class ApiAuthorizationMetadataPhase5Tests(unittest.TestCase):
    ...
    def test_all_195_operations_have_registry_backed_capability_and_structured_authorization(self) -> None:
        operations = self.operations()
        self.assertEqual(195, len(operations))
    ...
    def test_runtime_route_capability_smoke_is_blocking_in_make_and_foundation_ci(self) -> None:
        ...
        self.assertIn("rows.size() == 195", smoke)
