...
class BuildDescriptorTest {
    ...
    void normalizesAndExposesValidIdentity() {
        var descriptor = new BuildDescriptor(" InfraNexum ", "2.0.0-alpha.0.18", "2.0.0-draft.21", ComponentKind.SERVER);
    ...
    void rejectsBlankProduct() {
        assertThrows(ConfigurationException.class,
                () -> new BuildDescriptor(" ", "2.0.0-alpha.0.18", "2.0.0-draft.21", ComponentKind.SERVER));
    }
    ...
    void rejectsBlankBaseline() {
        assertThrows(ConfigurationException.class,
                () -> new BuildDescriptor("InfraNexum", "2.0.0-alpha.0.18", "", ComponentKind.SERVER));
    }

    @Test
    void rejectsMissingComponent() {
        assertThrows(NullPointerException.class,
                () -> new BuildDescriptor("InfraNexum", "2.0.0-alpha.0.18", "2.0.0-draft.21", null));
    }
}
