...
public final class Asset {
    ...
    public static Asset acquired(
        ...
        return new Asset(id, rsotObjectId, assetType, owningOrganizationId, owningSubdivisionId,
                acquisitionDate, acquisitionValue, acquiredFromPartnerId, AssetLifecycleStatus.ACQUIRED,
    ...
    public static Asset restore(
            ...
            String lastReason) {
        return new Asset(id, rsotObjectId, assetType, owningOrganizationId, owningSubdivisionId,
                acquisitionDate, acquisitionValue, acquiredFromPartnerId, lifecycleStatus, custodian, version,
    ...
    private Asset changed(
        ...
        return new Asset(id, rsotObjectId, assetType, owningOrganizationId, owningSubdivisionId,
                acquisitionDate, acquisitionValue, acquiredFromPartnerId, status, target, Math.addExact(version, 1),
