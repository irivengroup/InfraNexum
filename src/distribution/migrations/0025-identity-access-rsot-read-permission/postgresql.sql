...
('019ffbda-1080-7001-8001-000000000001',NULL,'rsot.read','rsot_object','read','NORMAL','ORGANIZATION',TRUE,TRUE,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,NULL)
...
WHERE organization_id IS NULL AND code='rsot.read'
ON CONFLICT DO NOTHING;
