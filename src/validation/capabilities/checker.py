...
class CapabilityChecker:
    ...
    RESOURCE_ROOT = Path(
        "src/components/core/capabilities/src/main/resources/io/infranexum/core/capabilities"
    )
    JAVA_ROOT = Path("src/components/core/capabilities/src/main/java/io/infranexum/core/capabilities")
