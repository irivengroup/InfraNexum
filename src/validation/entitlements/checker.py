...
class EntitlementChecker:
    ...
    def _check_java_invariants(self) -> None:
        files = {
            ...
            "activation": self._text(self.root / "src/components/core/capabilities/src/main/java/io/infranexum/core/capabilities/ActivationState.java", "CHECK-ENT-JAVA-005"),
