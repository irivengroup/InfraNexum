...
class AuditChecker:
    ...
    JAVA = MODULE / "src/main/java/io/infranexum/core/audit"
    JDBC = Path("src/components/adapters/persistence-jdbc")
    JDBC_JAVA = JDBC / "src/main/java/io/infranexum/adapters/persistence/jdbc"
    ...
    def _wiring(self) -> None:
        checks = (
            ...
            (Path("src/validation/architecture/policy.json"), "components/core/audit"),
