...
const MESSAGES = Object.freeze({
  en: Object.freeze({
    ...
    'iam.title': 'Users, groups, roles & permissions',
    'iam.description': 'Manage scoped RBAC identities and assignments through the Server authorization boundary.',
    'iam.loading': 'Loading…',
    ...
    'iam.groupId': 'Group UUID',
    'iam.memberId': 'Member UUID',
    'iam.add': 'Add',
    ...
    'iam.actorId': 'Actor UUID',
    'iam.roleRevoke': 'Revoke assignment',
    'iam.assignmentId': 'Assignment UUID',
    'iam.revoke': 'Revoke',
    'iam.scope': 'Scope',
    'iam.type': 'Type',
    ...
    'iam.permissionId': 'Permission UUID',
  ...
  fr: Object.freeze({
    ...
    'iam.title': 'Utilisateurs, groupes, rôles & permissions',
    'iam.description': 'Gérez les identités RBAC et leurs affectations scopées via la frontière d’autorisation du Server.',
    ...
    'iam.groupId': 'UUID du groupe',
    'iam.memberId': 'UUID du membre',
    'iam.add': 'Ajouter',
    ...
    'iam.actorId': 'UUID de l’acteur',
    'iam.roleRevoke': 'Révoquer une affectation',
    'iam.assignmentId': 'UUID de l’affectation',
    'iam.revoke': 'Révoquer',
    'iam.scope': 'Périmètre',
    'iam.type': 'Type',
    'iam.permissions': 'Permissions',
    ...
    'iam.permissionId': 'UUID de la permission',
  ...
  de: Object.freeze({
    ...
    'iam.title': 'Benutzer, Gruppen, Rollen & Berechtigungen',
    'iam.description': 'RBAC-Identitäten und bereichsbezogene Zuweisungen über die Server-Autorisierungsgrenze verwalten.',
    ...
    'iam.subdivisionOptional': 'UUID der Untergliederung (optional)',
    ...
    'iam.userId': 'Benutzer-UUID',
    'iam.effectiveFrom': 'Wirksam ab (ISO-8601)',
    'iam.effectiveTo': 'Wirksam bis (ISO-8601)',
    'iam.addMembership': 'Mitgliedschaft hinzufügen',
    'iam.userRoleAssign': 'Rolle Benutzer zuweisen',
    'iam.roleId': 'Rollen-UUID',
    'iam.assign': 'Zuweisen',
    ...
    'iam.groupId': 'Gruppen-UUID',
    'iam.memberId': 'Mitglieds-UUID',
    'iam.add': 'Hinzufügen',
    ...
    'iam.actorId': 'Akteur-UUID',
    'iam.roleRevoke': 'Zuweisung widerrufen',
    'iam.assignmentId': 'Zuweisungs-UUID',
    ...
    'iam.permissionId': 'Berechtigungs-UUID',
  ...
  es: Object.freeze({
    ...
    'iam.title': 'Usuarios, grupos, roles y permisos',
    'iam.description': 'Gestione identidades RBAC y asignaciones por ámbito mediante la frontera de autorización del Server.',
    ...
    'iam.groupId': 'UUID del grupo',
    'iam.memberId': 'UUID del miembro',
    'iam.add': 'Añadir',
    ...
    'iam.actorId': 'UUID del actor',
    'iam.roleRevoke': 'Revocar asignación',
    'iam.assignmentId': 'UUID de asignación',
    'iam.revoke': 'Revocar',
    'iam.scope': 'Ámbito',
    'iam.type': 'Tipo',
    ...
    'iam.permissionId': 'UUID del permiso',
  ...
  it: Object.freeze({
    ...
    'iam.title': 'Utenti, gruppi, ruoli & permessi',
    'iam.description': 'Gestisci identità RBAC e assegnazioni per ambito tramite il confine di autorizzazione del Server.',
    ...
    'iam.groupId': 'UUID gruppo',
    'iam.memberId': 'UUID membro',
    'iam.add': 'Aggiungi',
    ...
    'iam.actorId': 'UUID attore',
    'iam.roleRevoke': 'Revoca assegnazione',
    'iam.assignmentId': 'UUID assegnazione',
    'iam.revoke': 'Revoca',
    'iam.scope': 'Ambito',
    'iam.type': 'Tipo',
    ...
    'iam.permissionId': 'UUID dell’autorizzazione',
