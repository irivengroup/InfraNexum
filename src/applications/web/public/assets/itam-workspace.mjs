...
export function itamWorkspaceTemplate(configuration = {}) {
  ...
  return `
    ...
    <section class="card card-body bg-body-tertiary border mb-3 row g-2" aria-label="ITAM governance scope">
    ...
    <div class="nav nav-pills gap-2 mb-3" role="tablist" aria-label="ITAM">
...
function partnerPanel() {
  return `<section class="tab-pane" role="tabpanel" data-itam-panel="partners">
    <div class="d-grid gap-3">
      <div>
        <form id="itam-partner-filter" class="card card-body bg-body-tertiary border mb-3 row g-2">
        ...
        <pre id="itam-partner-detail" class="p-3 rounded border bg-body-tertiary mb-3 overflow-auto" tabindex="0">—</pre>
      </div>
      <div class="d-grid gap-3">
        <form id="itam-partner-create" class="border rounded p-3 bg-body-tertiary row g-2">
...
function assetPanel() {
  return `<section class="tab-pane" role="tabpanel" data-itam-panel="assets" hidden aria-hidden="true"><div class="d-grid gap-3"><div>
    ...
    <pre id="itam-asset-detail" class="p-3 rounded border bg-body-tertiary mb-3 overflow-auto" tabindex="0">—</pre>
    ...
    <form id="itam-asset-create" class="border rounded p-3 bg-body-tertiary row g-2"><h3 data-i18n="itam.assetCreate">Acquire asset</h3>
    ...
    <form id="itam-asset-lifecycle" class="border rounded p-3 bg-body-tertiary row g-2"><h3 data-i18n="itam.assetLifecycle">Selected asset lifecycle</h3>
...
function table(tbodyId,headings){return `<div class="border rounded overflow-hidden mb-3"><div class="table-responsive"><table class="table table-hover align-middle mb-0"><thead><tr>${headings.map(([k,f])=>`<th scope="col" data-i18n="${k}">${f}</th>`).join('')}</tr></thead><tbody id="${tbodyId}"></tbody></table></div></div>`;}
