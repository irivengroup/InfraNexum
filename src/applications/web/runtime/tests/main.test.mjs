...
import { createWebApplication, run } from '../main.mjs';
...
test('composition root loads repository version and injects runtime dependencies', async () => {
  ...
  assert.equal((await (await fetch(`${base}/api/v1/system/build`)).json()).version, '2.0.0-alpha.0.14');
