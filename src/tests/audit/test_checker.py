...
FILES = (
    ...
    "src/components/core/audit/src/main/java/io/infranexum/core/audit/AuditEntry.java",
    "src/components/core/audit/src/main/java/io/infranexum/core/audit/AuditJournal.java",
    "src/components/core/audit/src/main/java/io/infranexum/core/audit/AuditCanonicalizer.java",
    "src/components/core/audit/src/main/java/io/infranexum/core/audit/AuditExportService.java",
    "src/components/core/audit/src/main/java/io/infranexum/core/audit/AuditExportVerifier.java",
    "src/components/core/audit/src/main/java/io/infranexum/core/audit/AuditPurgeTombstone.java",
    "src/components/adapters/persistence-jdbc/MANIFEST.json",
    "src/components/adapters/persistence-jdbc/pom.xml",
    "src/components/adapters/persistence-jdbc/src/main/java/io/infranexum/adapters/persistence/jdbc/JdbcAuditJournal.java",
        ...
        with patch.object(sys, "argv", ["audit", "--root", str(SOURCE)]):
            with contextlib.redirect_stdout(io.StringIO()):
                with self.assertRaises(SystemExit) as caught:
                    runpy.run_path(str(SOURCE / "src/validation/audit/cli.py"), run_name="__main__")
