...
FILES = (
    ...
    "src/components/core/capabilities/src/main/java/io/infranexum/core/capabilities/ActivationState.java",
    "src/components/core/entitlements/MANIFEST.json",
    "src/components/core/entitlements/pom.xml",
    "src/components/core/entitlements/src/main/resources/io/infranexum/core/entitlements/activation-manifest.schema.json",
    "src/components/core/entitlements/src/main/resources/io/infranexum/core/entitlements/entitlement-contract-pack.json",
    "src/components/core/entitlements/src/main/java/io/infranexum/core/entitlements/ActivationManifestPayload.java",
    "src/components/core/entitlements/src/main/java/io/infranexum/core/entitlements/ActivationManifestVerifier.java",
    "src/components/core/entitlements/src/main/java/io/infranexum/core/entitlements/LiteEvaluationPolicy.java",
    "src/components/core/entitlements/src/main/java/io/infranexum/core/entitlements/TrustedTimeGuard.java",
    "src/components/core/entitlements/src/main/java/io/infranexum/core/entitlements/IntegrityProof.java",
