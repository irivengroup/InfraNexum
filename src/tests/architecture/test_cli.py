...
class ArchitectureCliTest(unittest.TestCase):
    ...
    def test_main_writes_pass_report(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            with redirect_stdout(io.StringIO()):
                code = main(["--root", str(root), "--policy", str(root / "src/validation/architecture/policy.json"), "--json-report", str(report)])
    ...
    def test_module_entry_point_exits_with_success(self) -> None:
        ...
        arguments = [
            ...
            str(root),
            "--policy",
            str(root / "src/validation/architecture/policy.json"),
        ]
