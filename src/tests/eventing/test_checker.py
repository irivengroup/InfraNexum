...
FILES = (
    ...
    "src/components/core/events/src/main/java/io/infranexum/core/events/EventEnvelope.java",
...
class EventingCheckerTest(unittest.TestCase):
    ...
    def test_java_record_presence_and_field_order_are_enforced(self) -> None:
        path = self.root / "src/components/core/events/src/main/java/io/infranexum/core/events/EventEnvelope.java"
