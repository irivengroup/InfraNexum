...
L’incrément `2.0.0-alpha.0.12` matérialise le socle de `PGM-02-E06` dans `src/components/core/audit` et son adaptateur JDBC. Il ne publie pas encore l’API IAM d’audit : IAM doit devenir producteur des événements complets et autoriser les recherches/exports dans un incrément ultérieur.
